...
<head>
    ...
    <title>文件上传(完成页面上传文件在D盘target文件夹下)</title>
    <%--文件上传页面--%>
            ...
            <ul class="sidebar-menu" data-widget="tree">
              ...
              <i class="fa fa-angle-left pull-right"></i>
                    ...
                    <ul class="treeview-menu">
                        <li><a href="${pageContext.request.contextPath}/Commoditylist/upload"><i class="fa fa-circle-o"></i>文件上传</a></li>
                        <li><a href="${pageContext.request.contextPath}/Commoditylist/download"><i class="fa fa-circle-o"></i>文件下载</a></li>
                    </ul>
                </li>
            </ul>
        </section>
...
<script type="text/javascript">
    function UpladFile() {
        ...
        var FileController = "${pageContext.request.contextPath}/Commoditylist/upload"; // 接收上传文件的后台地址
        // FormData 对象
