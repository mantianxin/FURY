...
<div class="wrapper">
    ...
    <aside class="main-sidebar">
        ...
        <section class="sidebar">
            ...
            <ul class="sidebar-menu" data-widget="tree">
                ...
                <li class="treeview">
                    <a href="#">
                        <i class="fa fa-dashboard"></i> <span>查询全部订单</span>
                        <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
                    </a>
                    <ul class="treeview-menu">
                        <li><a href="${pageContext.request.contextPath}/Commoditylist/uppages"><i class="fa fa-circle-o"></i>文件上传（已完成）</a></li>
                        <li><a href="${pageContext.request.contextPath}/downloadeasypoi"><i class="fa fa-circle-o"></i>文件下载（未完成）</a></li>
                        <li><a href="#"><i class="fa fa-circle-o"></i>easypoi导入表格数据至数据库（未完成）</a></li>
                        <li><a href="#"><i class="fa fa-circle-o"></i>easypoi从数据库导出数据至数据库（未完成）</a></li>
                    </ul>
                </li>
            </ul>
        </section>
    ...
    <div class="content-wrapper">
        ...
        <section class="content">
            <div class="row">
                <div class="col-xs-12">
                    <div class="box"><!-- 表格代码开始  效果：没有阴影-->
                        <div class="box-header"><!-- 表头代码开始-->
                            ...
                            <table id="example2" class="table table-bordered table-hover">
                               ...
                               <c:forEach items="${commodity}" var="s" varStatus="vs">
                                <tr>
                                    ...
                                    <td>${s.station}</td>
                                    <td>${s.cname}</td>
                                    <td><a class="btn-app" href="${pageContext.request.contextPath}/Commoditylist/updatecommodityjsp">修改订单</a><a class="btn-app" href="${pageContext.request.contextPath}/Commoditylist/delete?id=${s.id}">删除订单</a>
                                    <a class="btn-google" href="${pageContext.request.contextPath}/Commoditylist/addjsp">增加订单</a><a class="btn-google" href="${pageContext.request.contextPath}/Commoditylist/oneselect?id=${s.id}">查看订单信息</a></td>
                                </tr>
                               </c:forEach>
                                </tbody>
                            </table>
