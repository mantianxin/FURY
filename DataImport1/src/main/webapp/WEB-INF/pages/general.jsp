        ...
        <section class="content">
            <div class="row">
                ...
                <div class="col-md-6">
                    ...
                    <div class="box box-info">
                        <div class="box-header with-border">
                            <h3 class="box-title">注册表单</h3>
                        </div>
                        <!-- /.box-header -->
                        <!-- form start -->
                        <form class="form-horizontal" action="${pageContext.request.contextPath}/Commoditylist/regist" method="post">
                            ...
                            <div class="box-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input id="Uname" type="text"  name="Uname" class="form-control"  placeholder="Uname">
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input id="Usex" name="Usex" type="text" class="form-control"   placeholder="Usex">
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input id="Upassword" type="text" name="Upassword" class="form-control"  placeholder="Upassword">
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input id="Uemail"  type="text"name="Uemail"  class="form-control"  placeholder="Uemail">
                                    </div>
                                </div>

                                <div class="form-group">
                                    <label for="Uphonenumber" class="col-sm-2 control-label">电话</label>

                                    <div class="col-sm-10">
                                        <input id="Uphonenumber" type="text" name="Uphonenumber" class="form-control"  placeholder="Uphonenumber">
                                    </div>
                                </div>

                                <div class="form-group">
                                    <label for="Uaddress" class="col-sm-2 control-label">居住地址</label>

                                    <div class="col-sm-10">
                                        <input id="Uaddress" type="text" name="Uaddress" class="form-control"  placeholder="Uaddress">
                                    </div>
                                </div>

                                <div class="form-group">
                                    <label for="Love" class="col-sm-2 control-label">爱好</label>

                                    <div class="col-sm-10">
                                        <input  id="Love" name="Love" type="text"  class="form-control" placeholder="Love">
                                    </div>
                                </div>

                                <div class="form-group">
                                    <label for="Umajor" class="col-sm-2 control-label">职业</label>

                                    <div class="col-sm-10">
                                        <input  id="Umajor" name="Umajor" type="text" class="form-control"  placeholder="Umajor">
                                    </div>
                                </div>

                                <div class="form-group">
                                    <label for="Ustarttime" class="col-sm-2 control-label">开始注册时间</label>

                                    <div class="col-sm-10">
                                        <input id="Ustarttime" name="Ustarttime"  type="Date"  class="form-control"     placeholder="Ustarttime">
                                    </div>
                                </div>

                                <div class="form-group">
                                    <label for="Uendtime"   class="col-sm-2 control-label">注销账户时间</label>

                                    <div class="col-sm-10">
                                        <input id="Uendtime" name="Uendtime"  type="Date" class="form-control"   placeholder="Uendtime">
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input  id="Ubirthday" name="Ubirthday"  type="Date" class="form-control"  placeholder="Ubirthday">
                                    </div>
                                </div>
