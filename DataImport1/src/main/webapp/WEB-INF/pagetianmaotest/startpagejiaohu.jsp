...
<div class="homepageDiv">
    <script>
        $(function(){
            $("div.right span").mouseenter(function(){
                var left = $(this).position().left;
                var top = $(this).position.top;
                var width = $(this).css("width");
                var destLeft = parseInt(left)+parseInt(width)/2;
                $("img#catear").css("left",destalaeft);
    ...
    <img class="catear" id="catear" src="https://how2j.cn/tmall/img/site/catear.png" style="left:260.5px; top:159.65; display:none;">
    <div class="categoryWithCarousel">
        <div class="headbar show1">
            ...
            <div class="rightMenu">
                <span><a class="#nowhere"><img src="https://how2j.cn/tmall/img/site/chaoshi.png"></a></span>
                <span><a class="#nowhere"><img src="https://how2j.cn/tmall/img/site/guoji.png"></a></span>
                <span>
